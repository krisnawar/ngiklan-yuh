...
<div class="content-wrapper">
    ...
    <section class="content">
                ...
                <div class="box box-info">
                    ...
                    <div class="box-body">
                        <form class="form-horizontal" method="POST" enctype="multipart/form-data">
                            ...
                            <div class="form-group">
                                <label for="bukti_siar" class="col-sm-2 control-label">Upload Bukti Siar</label>
                                <div class="col-sm-4">
                                    <input type="file" name="bukti_siar" id="bukti_siar" placeholder="Upload Bukti Siar">
                                    <small class="form-text text-danger"><?= form_error('bukti_siar'); ?></small>
                                </div>
                            </div>
                            <div class="box-footer">
        ...
        <?php if ($detail_iklan->row()->mou != NULL && $detail_iklan->row()->status_iklan == 3): ?>
        <div class="row" id="pwd-container">
            <div class="col-md-12">
                <div class="box box-info">
                    <div class="box-header with-border">
                        <h3 class="box-title">Lanjutkan Proses</h3>
                    </div>
                    <div class="box-body">
