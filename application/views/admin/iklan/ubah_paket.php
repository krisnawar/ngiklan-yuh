            ...
            <div class="col-md-12">
                <div class="box box-info">
                    <div class="box-header with-border">
                        <h3 class="box-title">Form Ubah Paket Iklan</h3>
                    </div>
                    <!-- /.box-header -->
                    <!-- form start -->
                    <form class="form-horizontal" action="" method="post">
                        <div class="box-body">
                            ...
                            <div class="form-group">
                                ...
                                <div class="col-sm-10">
                                    <input type="text" name="kategori_paket" class="form-control" id="kategori_paket" placeholder="Masukkan Kategori Paket" value="<?= $paket["kategori_paket"] ?> ">
                            ...
                            <div class="form-group">
                                ...
                                <div class="col-sm-10">
                                    <input type="text" name="jenis_paket" class="form-control" id="jenis_paket" placeholder="Masukkan Jenis Paket"value="<?= $paket["jenis_paket"] ?> ">
                            ...
                            <div class="form-group">
                                ...
                                <div class="col-xs-4">
                                    <input type="text" name="frekuensi_paket" class="form-control" id="frekuensi_paket" placeholder="Masukkan Frekuensi Paket" value="<?= $paket["frekuensi_paket"] ?> ">
                                ...
                                <div class="col-xs-4">
                                    <input type="text" name="bonus_paket" class="form-control" id="bonus_paket" placeholder="Masukkan Frekuensi Bonus" value="<?= $paket["bonus_paket"] ?> ">
                            ...
                            <div class="form-group">
                                ...
                                <div class="col-xs-4">
                                    <input type="text" name="durasi_paket" class="form-control" id="durasi_paket" placeholder="Masukkan Durasi Iklan" value="<?= $paket["durasi_paket"] ?> ">
                                ...
                                <div class="col-xs-4">
                                    <input type="text" name="harga_paket" class="form-control" id="harga_paket" placeholder="Masukkan Harga paket" value="<?= $paket["harga_paket"] ?> ">
                        ...
                        <div class="box-footer">
                            <button type="submit" class="btn btn-info pull-right" name="ubah_paket">Ubah Paket</button>
                        </div>
                        <!-- /.box-footer -->
                    </form>
                </div>
